  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        PolySansMedianItalic: ['var(--font-PolySans-medianItalic)'],
        PolySansBulky: ['var(--font-PolySans-Bulky)'],
        PolySansBulkyItalic: ['var(--font-PolySans-BulkyItalic)'],
        PolySansSlims: ['var(--font-PolySans-slims)'],
        PolySansSlimsItalic: ['var(--font-PolySans-slimsItalic)'],
        KomuA: ['var(--font-KomuA)'],
        Circular: ['var(--font-Circular)'],
        CircularBold: ['var(--font-CircularBold)'],
        kanakiraBold: ['var(--font-CircularBold)'],
        kanakiraItalic: ['var(--font-PolySans-BulkyItalic)'],
        kanakiraHeavy: ['var(--font-PolySans-Bulky)'],
        kanakiraHeavyItalic: ['var(--font-PolySans-BulkyItalic)'],
        mabryBold: ['var(--font-CircularBold)'],
