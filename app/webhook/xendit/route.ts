...
import { customerIksanId, customerOrder, payment, orderItem, xenditWebhookLog } from '@/drizzle/schema'; // Import your Drizzle ORM schema
...
export async function POST(req: NextRequest) {
    try {
        ...
        await db.insert(xenditWebhookLog).values({
            eventType: body.status || null,
