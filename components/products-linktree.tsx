...
function ProductsClients({
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center max-w-screen-lg mx-auto px-0 py-10 pt-0 bg-stone-100 text-stone-950 ">
                <section className='flex flex-col w-full'>
                    ...
                    <div className='flex flex-col mt-12 gap-4 md:px-10'>
                        {selectedCategory === 'all' && (
                            <>
                                <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-x-4 gap-y-10">
                        ...
                        {selectedCategory === 'ebooks' && (
                            <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-24 ">
